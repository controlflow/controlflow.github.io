...
Еще одним минусом является плохое пересечение с типами-значениям: авто-свойство внутри конструктора не классифицируется как переменная (в отличие от `readonly`-полей), что запрещает доступ на *частичную запись* таких авто-свойств:
...
Ну и последним позитивным изменением авто-свойств стал просто-напросто "захаканный" анализ инициализации структуры.
